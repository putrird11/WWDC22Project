...
//  WWDC22Project
//
//  Created by PUTRI RAHMADEWI on 23/01/23.
//
...
class PlayView: UIViewController{
    ...
    public func showPopUpDisclaimer(){
        ...
        buttonNext.addTarget(self, action: #selector(actionGoToPlayView), for: .touchUpInside)
    }
  ...
  @objc func actionGoToPlayView(_ sender: UIButton){
      playTouchSound()
